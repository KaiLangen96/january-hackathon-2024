...
urlpatterns = [
    ...
    path(
        "saving-goals/<int:pk>/update/", update_saving_goal, name="update_saving_goal"
    ),
    path(
        "saving-goals/<int:goal_pk>/add-deposit/",
        add_savings_deposit,
        name="add_savings_deposit",
    ),
    path(
        "saving-goals/<int:pk>/delete/",
        SavingGoalDeleteView.as_view(),
